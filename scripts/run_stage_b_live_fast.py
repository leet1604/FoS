"""Automatic off-target discovery with bounded live settings."""
...
def main() -> None:
    ...
    parser.add_argument("--output", default="outputs/stage_b_live_fast/result.json")
    ...
    deps = build_live_dependencies(
        ...
        analog_similarity_threshold=0.80,
        max_analogs=10,
        max_final_targets=1,
